...
contract BattleSystem {
     ...
     */
    function startBattle(uint256 _nftId1, uint256 _player1BetAmount) external {
        // 验证调用者是否为NFT持有者
        require(
     ...
     */
    function joinBattleAndFinalize(uint256 _battleId, uint256 _nftId2, uint256 _player2BetAmount) external {
